        ...
        <div class="col-xs-12">
            <div class="box box-danger collapsed-box">
                ...
                <div class="box-body" style="display: none">
                    <form class="form-horizontal" id="reportForm" action="report-academy.php" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <div class="checkbox">
                                    <button type="button" id="makeReport" class="btn btn-primary">Сформировать
                                        отчёт</button>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="reportDivisionName" value="Военная академия связи">
                        <input type="hidden" name="reportCityName" value="военный городок №123">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="box box-widget widget-user cityColumn">
                    ...
                    <a class="cityUrl" href="{{ url('/sectors/'.$sector->id) }}">
                        <div class="widget-user-header bg-black cityPicture"
                            style="background-image: url('{{ asset('img/sectors/'.$sector->id) }}.png');">
                            <h3 class="widget-user-username cityName" 
                            style="text-shadow: 2px 1px 3px rgba(0, 0, 0, 0.88);">
                                {{ $sector->name }}
                            </h3>

                            <h5 class="widget-user-desc cityAdress" 
                            style="text-shadow: 2px 1px 3px rgba(0, 0, 0, 0.88);">
                                {{ $sector->address }}
                            </h5>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="info-box bg-red-gradient">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Тепловая энергия <span class="label label-default"><span
                                                    class="cityHeatMetersCount">
